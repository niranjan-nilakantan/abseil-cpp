...
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "IntelLLVM")
  if(MSVC)
    # clang-cl is half MSVC, half LLVM
    set(ABSL_DEFAULT_COPTS "${ABSL_CLANG_CL_FLAGS}" /fp:precise -Wno-microsoft-cast)
    set(ABSL_TEST_COPTS "${ABSL_CLANG_CL_TEST_FLAGS}" /fp:precise -Wno-microsoft-cast)
  else()
    set(ABSL_DEFAULT_COPTS "${ABSL_LLVM_FLAGS}" -fp-model=precise)
    set(ABSL_TEST_COPTS "${ABSL_LLVM_TEST_FLAGS}" -fp-model=precise)
  endif()
